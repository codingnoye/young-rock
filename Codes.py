...
Code([('attack(3)', 0, 0)], 2)
Code([('attack(2)', 0, 0), ('attack(2)', 0, 0)], 2)
...
# 3코
Code([('attack(1),attack(1)', 0, 0), ('attack(1),attack(1)', 0, 0)], 3)
Code([('attack(player.level)', 0, 0)], 3)
Code([('attack(enemy.level)', 0, 0)], 3)
...
Code([('attack(enemy.shield//2)', 0, 0)], 3, 11)
# 4코
...
Code([('if enemy.armor>=10:', 0, 1), ('enemy.health-=2', 0, -1)], 4, 11)
Code([('if enemy.armor>=player.power:', 0, 1), ('player.power+5', 1, -1)], 4, 11)
Code([('if player.shield>=10:', 0, 1), ('player.shield-=10', 1, 0), ('player.evade+=1', 1, -1)], 4, 11)
