...
Code([('attack(player.power), attack(player.power)', 0, 0)], 2)
Code([('enemy.health-=1', 0, 0)], 2)
# 4코
...
Code([('while enemy.health%7==0:', 0, 1), ('player.health-=2', 1, 0)], 3)
