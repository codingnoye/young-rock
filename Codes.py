...
Code([('if player.power>=1:', 0, 1)], 1)
Code([('else:', 0, 1)], 2)
# 2코
Code([('for i in range(2):', 0, 1)], 2)
Code([('for j in range(2):', 0, 1)], 2)
Code([('if True:', 0, 1)], 2)
# 3코
Code([('for j in range(i):', 0, 1)], 3)
Code([('for j in range(3, 5):', 0, 1)], 3)
Code([('for i in range(enemy.level):', 0, 1)], 3)
Code([('for i in range(player.level):', 0, 1)], 3)
Code([('for i in range(4):', 0, 1), ('if player.health<50:', 1, 1)], 3)
# 4코
Code([('for i in range(3):', 0, 1)], 4)
Code([('while player.shield>=5:', 0, 1), ('player.shiled-=5', 0, 0)], 4)
...
Code([('while enemy.health%7==0:', 0, 1), ('player.health-=2', 0, 0)], 5)
